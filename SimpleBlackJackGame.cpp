 ...
 *
 * Name:            Christian Hill
 * Class:           code sampled from Chegg.com
 * Project:         creates a simple black jack game.
 * Due Date:        code created: 10-08-18
 *
/'*'*'*'*'*'*'*'*'*'*'*'*'*'*'*'*'*'*'*'*'*'*'*'*'*'*'*'*'*'*'*'*'*'*'*'*/
/*
...
// This game does not allow you to quit.
// Need to add a quit functionality to the menu.
// Need to add the Card class to handle private and public classes.
